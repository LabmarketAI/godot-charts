...
- [ ] 1.5 Record the pure typed-GDScript addon decision, select the standard Godot version floor, and benchmark only the representative workloads that could justify a future optional GDExtension accelerator.
